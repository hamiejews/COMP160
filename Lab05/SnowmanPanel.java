...
public class SnowmanPanel extends JPanel{
  ...
  public void paintComponent (Graphics page)
  {
    ...
    page.fillOval (270, -10, 40, 40);  // sun
    ...
    page.drawArc (MID - 10, TOP + 20, 20, 10, 170, -160);   // smile
    ...
    page.fillOval (MID - 5, TOP + 50, 10, 10);   // Top Button
    page.fillOval (MID - 5, TOP + 65, 10, 10);    // Bottom Button
    
    page.drawString ("Tom", MID - 110, TOP - 30);
  }
}
