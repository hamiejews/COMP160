...
public class CalculatorGUIPanel extends JPanel {
  ...
  public CalculatorGUIPanel() {
    ...
    /* Create a button with each button label and add it to buttonGrid */
...
/* new class represents a listener for button presses */
  private class ButtonListener implements ActionListener{
    
/* what program does when a button has been pressed */
